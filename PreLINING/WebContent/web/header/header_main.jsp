										...
										<div class="tab-content-inner active" data-content="signup">
											...
											<hr style="border-color:rgba(251, 180, 72, 0.3)">
												...
												<div class="row form-group">
													<div class="col-md-12">
														<label for="activities">가게이름</label>
														<input type="text" name="s_name" value="${bookshop.name }" class="form-control" readonly>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
														<label>현재 내 순번</label>
														<input type="text" name="q_num" value="${myqnum }" class="form-control" readonly>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
														<input type="button" class="btn btn-primary btn-block" value="가게 정보 보기"
														onclick="location.href='${pageContext.request.contextPath }/ShopDetailController?num=${bookshop.num}'">
													</div>
												</div>
										</div>
									</div>

						...
						<div class="col-md-4 col-md-push-4 animate-box" data-animate-effect="fadeIn">
							<div class="form-wrap">
								<div class="tab tab-content tab-content-inner active">
									<form action="${pageContext.request.contextPath }/LoginController" method = "post" name="loginForm" onsubmit="return check()">
									...
									<hr>
									<h5>아직 회원이 아니신가요? &nbsp; <a href="${pageContext.request.contextPath }/web/member/joinForm.jsp">회원가입</a></h5>
								</div>
							</div>
						</div>	
					</div>	

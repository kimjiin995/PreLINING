						...
						<h2 class="text-center">회원가입</h2>
							<div class="form-wrap">
								<div class="tab tab-content tab-content-inner active">
									<form action="${pageContext.request.contextPath }/JoinController" method = "post" name="form" onsubmit="return check()">
										...
										<button onclick="goPopup();" type="button" class="btn btn-primary btn-join">주소 찾기</button>
                              			<input type="text" name="addr" class="form-control" readonly> <br>
										<label class="text-left">type</label><br>
 										<input type = "radio" name = "type" value = "1">회원 &nbsp; &nbsp; &nbsp;
										<input type = "radio" name = "type" value = "2">상점
										<br><br>
										<input type="submit" class="btn btn-primary btn-block" value="가입하기">
									</form>	
									<hr>
									<h5>이미 가입하셨나요? &nbsp; <a href="${pageContext.request.contextPath }/web/member/loginForm.jsp">로그인</a></h5>
								</div>
							</div>
						</div>
					</div>					
